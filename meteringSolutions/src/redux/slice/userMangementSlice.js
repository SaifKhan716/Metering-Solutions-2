...
const userMangementSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      // //                 state.loading = false;
      // // const newUser = action.payload;
      // // // Prepend to state arrays to show newest first
      // // state.data.unshift(newUser);
      // // state.fetchUsersByQueryData.unshift(newUser);
...
export const userQueryData = (state) =>
  state.usersMangement.fetchUsersByQueryData;
...
export const userManagementSelectedUser = (state) =>
  state.usersMangement.selectedUser;
